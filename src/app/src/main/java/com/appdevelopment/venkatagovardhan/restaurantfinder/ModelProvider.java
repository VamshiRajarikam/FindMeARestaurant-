...
public class ModelProvider {
    ...
    public void initData(){
        ...
        Store storeProjects = new Store(STORE_PROJECTS_ID, "issues");
        ...
        Store storeIssues = new Store(STORE_ISSUES_ID, "projects");
        ...
        Store storeMembers = new Store(STORE_MEMBERS_ID, "Members");
